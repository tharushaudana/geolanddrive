<template>
    <div class="container">
        <h1>Privacy Policy for GeoLand Drive</h1>

        <p>At geolanddrive.web.app, accessible from https://geolanddrive.web.app, one of our main priorities is the privacy
            of
            our visitors. This Privacy Policy document contains types of information that is collected and recorded by
            geolanddrive.web.app and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards
            to
            the information that they shared and/or collect in geolanddrive.web.app. This policy is not applicable to any
        ...
        <p>geolanddrive.web.app follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <p>Like any other website, geolanddrive.web.app uses "cookies". These cookies are used to store information
            including
        ...
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
            geolanddrive.web.app.
        </p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
            their respective advertisements and links that appear on geolanddrive.web.app, which are sent directly to users'
        ...
        <p>Note that geolanddrive.web.app has no access to or control over these cookies that are used by third-party
            advertisers.</p>

        <h2>Third Party Privacy Policies</h2>

        <p>geolanddrive.web.app's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
            to
        ...
        <p>geolanddrive.web.app does not knowingly collect any Personal Identifiable Information from children under the age
            of
        ...
        <p>tharusha.udana529@gmail.com</p>
    </div>
</template>